...
def test_split(train,LR):
    cat_features = [cont for cont in list(train.select_dtypes(
        include=['float64', 'int64']).columns) if cont not in ['y']]
...
def box_split(train,test):
    ...
    # IV_dict.pop('avg_loanamount_city_br_encoding_Bin')
    #
    # IV_dict.pop('avg_loanamount_country_br_encoding_Bin')
    # IV_dict.pop('avg_M2_prov_br_encoding_Bin')
    # #
    # IV_dict.pop('avg_M3_prov_br_encoding_Bin')
...
if __name__ == '__main__':
    ...
    # file = 'approve_addr_feature_pd10.xlsx'
